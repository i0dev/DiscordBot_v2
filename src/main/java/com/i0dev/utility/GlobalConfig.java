...
public class GlobalConfig {
    ...
    public static String CHANGELOG_CHANNEL;
    ...
    public static void initGlobalConfig() {
        ...
        CHANGELOG_CHANNEL = getConfig.get().getLong("channels.changelogChannelID").toString();
        NOT_PLUGIN_MODE = getConfig.get().getString("messages.botNotInPluginMode");
