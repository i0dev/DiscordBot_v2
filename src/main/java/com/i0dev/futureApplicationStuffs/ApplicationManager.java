...
import com.i0dev.commands.discord.completedModules.giveaway.*;
...
public class ApplicationManager {
    ...
    public static String usage() {
        ...
        builder.append("**:clipboard: Application Commands :clipboard:**").append("\n\n");
    ...
    public void run(GuildMessageReceivedEvent e) {
        ...
        if (message[0].equalsIgnoreCase(GlobalConfig.GENERAL_BOT_PREFIX + "giveaway")) {
            if (message.length == 1) {
