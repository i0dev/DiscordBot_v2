...
public class CommandMemberCount extends DiscordCommand {
    ...
    @Override
    public void init() {
        REQUIRE_PERMISSIONS = Configuration.getBoolean("commands.memberCount.requirePermission");
        REQUIRE_LITE_PERMISSIONS = Configuration.getBoolean("commands.memberCount.permissionLiteMode");
        MESSAGE_CONTENT = Configuration.getString("commands.memberCount.messageContent");
        MESSAGE_FORMAT = Configuration.getString("commands.memberCount.format");
        COMMAND_ENABLED = Configuration.getBoolean("commands.memberCount.enabled");
    }
