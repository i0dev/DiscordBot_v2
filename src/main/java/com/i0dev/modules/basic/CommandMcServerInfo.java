...
public class CommandMcServerInfo extends DiscordCommand {
    ...
    public static String cantFindServerError;

    @Override
    public void init() {
        REQUIRE_PERMISSIONS = Configuration.getBoolean("commands.MCServerInfo.requirePermission");
        REQUIRE_LITE_PERMISSIONS = Configuration.getBoolean("commands.MCServerInfo.permissionLiteMode");
        MESSAGE_FORMAT = Configuration.getString("commands.MCServerInfo.format");
        COMMAND_ENABLED = Configuration.getBoolean("commands.MCServerInfo.enabled");
        messageTitle = Configuration.getString("commands.MCServerInfo.messageTitle");
        cantFindServerError = Configuration.getString("commands.MCServerInfo.cantFindServerError");
    }
