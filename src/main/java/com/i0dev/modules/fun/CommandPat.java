...
public class CommandPat extends DiscordCommand {
    ...
    @Override
    public void init() {
        REQUIRE_PERMISSIONS = Configuration.getBoolean("commands.fun_pat.requirePermission");
        REQUIRE_LITE_PERMISSIONS = Configuration.getBoolean("commands.fun_pat.permissionLiteMode");
        MESSAGE_CONTENT = Configuration.getString("commands.fun_pat.messageContent");
        MESSAGE_FORMAT = Configuration.getString("commands.fun_pat.format");
        COMMAND_ENABLED = Configuration.getBoolean("commands.fun_pat.enabled");
    }
