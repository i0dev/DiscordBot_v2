...
public class CommandEightBall extends DiscordCommand {
    ...
    @Override
    public void init() {
        REQUIRE_PERMISSIONS = Configuration.getBoolean("commands.fun_8ball.requirePermission");
        REQUIRE_LITE_PERMISSIONS = Configuration.getBoolean("commands.fun_8ball.permissionLiteMode");
        MESSAGE_CONTENT = Configuration.getString("commands.fun_8ball.messageContent");
        MESSAGE_FORMAT = Configuration.getString("commands.fun_8ball.format");
        COMMAND_ENABLED = Configuration.getBoolean("commands.fun_8ball.enabled");
    }
