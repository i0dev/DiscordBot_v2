...
public class CommandSlap extends DiscordCommand {
    ...
    @Override
    public void init() {
        REQUIRE_PERMISSIONS = Configuration.getBoolean("commands.fun_slap.requirePermission");
        REQUIRE_LITE_PERMISSIONS = Configuration.getBoolean("commands.fun_slap.permissionLiteMode");
        MESSAGE_CONTENT = Configuration.getString("commands.fun_slap.messageContent");
        MESSAGE_FORMAT = Configuration.getString("commands.fun_slap.format");
        COMMAND_ENABLED = Configuration.getBoolean("commands.fun_slap.enabled");
