...
public class Leaderboard extends DiscordCommand {
    ...
    @Override
    public void init() {
        PERMISSION_STRICT = Configuration.getBoolean("modules.points.parts.leaderboard.permission.strict");
        PERMISSION_LITE = Configuration.getBoolean("modules.points.parts.leaderboard.permission.lite");
        PERMISSION_ADMIN = Configuration.getBoolean("modules.points.parts.leaderboard.permission.admin");
        ENABLED = Configuration.getBoolean("modules.points.parts.leaderboard.enabled");
        MESSAGE_CONTENT = Configuration.getString("modules.points.parts.leaderboard.message.general");

        MESSAGE_FORMAT = Configuration.getString("modules.points.parts.leaderboard.message.format");
    }
