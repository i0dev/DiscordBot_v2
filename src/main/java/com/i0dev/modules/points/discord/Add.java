...
public class Add extends DiscordCommand {
    ...
    @Override
    public void init() {
        PERMISSION_STRICT = Configuration.getBoolean("modules.points.parts.add.permission.strict");
        PERMISSION_LITE = Configuration.getBoolean("modules.points.parts.add.permission.lite");
        PERMISSION_ADMIN = Configuration.getBoolean("modules.points.parts.add.permission.admin");
        ENABLED = Configuration.getBoolean("modules.points.parts.add.enabled");
        MESSAGE_CONTENT = Configuration.getString("modules.points.parts.add.message.general");
    }
