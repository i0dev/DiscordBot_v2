...
public class cmdIslandLeader extends ListenerAdapter {

    private final String Identifier = "Island Leader";
    private final List<String> COMMAND_ALIASES = getConfig.get().getStringList("commands.islandLeader.aliases");
    private final boolean REQUIRE_PERMISSIONS = getConfig.get().getBoolean("commands.islandLeader.requirePermission");
    private final boolean REQUIRE_LITE_PERMISSIONS = getConfig.get().getBoolean("commands.islandLeader.permissionLiteMode");
    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent e) {
        ...
        if (MessageAliases.isMessageACommand(e.getMessage(), COMMAND_ALIASES)) {
            ...
            RoleQueue.addToQueue(MentionedUser.getId(), islandLeaderRoleID);
