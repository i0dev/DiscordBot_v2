package com.i0dev.command.discord.moderation.blacklist;
...
public class cmdBlacklistClear extends ListenerAdapter {

    private final String Identifier = "Blacklist Clear";
    private final List<String> COMMAND_ALIASES = getConfig.get().getStringList("commands.blacklist_clear.aliases");
    private final boolean REQUIRE_PERMISSIONS = getConfig.get().getBoolean("commands.blacklist_clear.requirePermission");
    private final boolean REQUIRE_LITE_PERMISSIONS = getConfig.get().getBoolean("commands.blacklist_clear.permissionLiteMode");
    private final String MESSAGE_CONTENT = getConfig.get().getString("commands.blacklist_clear.messageContent");
    private final String MESSAGE_FORMAT = getConfig.get().getString("commands.blacklist_clear.format");
    private final boolean COMMAND_ENABLED = getConfig.get().getBoolean("commands.blacklist_clear.enabled");
    private final boolean LOGS_ENABLED = getConfig.get().getBoolean("commands.blacklist_clear.log");
    private final String LOGS_MESSAGE = getConfig.get().getString("commands.blacklist_clear.logMessage");
