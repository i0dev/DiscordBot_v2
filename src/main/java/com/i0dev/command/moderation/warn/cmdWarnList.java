    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent e) {
        ...
        if (MessageAliases.isMessageACommand(e.getMessage(), COMMAND_ALIASES)) {
            ...
            for (JSONObject obj : list) {
                ...
                desc.append(main.java.com.i0dev.util.Placeholders.convert(LIST_FORMAT
            ...
            e.getChannel().sendMessage(main.java.com.i0dev.util.EmbedFactory.get().createSimpleEmbed(main.java.com.i0dev.util.Placeholders.convert(MESSAGE_TITLE, e.getAuthor()), main.java.com.i0dev.util.Placeholders.convert(desc.toString(), e.getAuthor())).build()).queue();
