package com.i0dev.command.moderation.screenshare;

import com.i0dev.entity.Blacklist;
import com.i0dev.entity.Screenshare;
...
public class cmdScreenshareAdd extends ListenerAdapter {

    private final String Identifier = "Blacklist Add";
    private final List<String> COMMAND_ALIASES = getConfig.get().getStringList("commands.screenshare_add.aliases");
    private final boolean REQUIRE_PERMISSIONS = getConfig.get().getBoolean("commands.screenshare_add.requirePermission");
    private final boolean REQUIRE_LITE_PERMISSIONS = getConfig.get().getBoolean("commands.screenshare_add.permissionLiteMode");
    private final String MESSAGE_CONTENT = getConfig.get().getString("commands.screenshare_add.messageContent");
    private final String USER_ALREADY_ON_LIST = getConfig.get().getString("commands.screenshare_add.userAlreadyOnList");
    private final String MESSAGE_FORMAT = getConfig.get().getString("commands.screenshare_add.format");
    private final boolean COMMAND_ENABLED = getConfig.get().getBoolean("commands.screenshare_add.enabled");
    private final boolean LOGS_ENABLED = getConfig.get().getBoolean("commands.screenshare_add.log");
    private final String LOGS_MESSAGE = getConfig.get().getString("commands.screenshare_add.logMessage");
