...
public class cmdConfirmCell extends ListenerAdapter {

    private final String Identifier = "Confirm Cell";
    private final List<String> COMMAND_ALIASES = getConfig.get().getStringList("commands.confirmCell.aliases");
    private final boolean REQUIRE_PERMISSIONS = getConfig.get().getBoolean("commands.confirmCell.requirePermission");
    private final boolean REQUIRE_LITE_PERMISSIONS = getConfig.get().getBoolean("commands.confirmCell.permissionLiteMode");
    private final String MESSAGE_CONTENT = getConfig.get().getString("commands.confirmCell.messageContent");
    private final String MESSAGE_MESSAGE_TITLE = getConfig.get().getString("commands.confirmCell.confirmMessageTitle");
    private final String MESSAGE_MESSAGE_DESC = getConfig.get().getString("commands.confirmCell.confirmMessageDesc");
    private final String MESSAGE_FORMAT = getConfig.get().getString("commands.confirmCell.format");
    private final boolean COMMAND_ENABLED = getConfig.get().getBoolean("commands.confirmCell.enabled");
    private final String confirmedCellChannelID = getConfig.get().getString("channels.confirmedCellChannelID");
